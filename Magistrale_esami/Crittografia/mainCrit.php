...
<div id="title" class="container">
    <h1 id="h1Title"> Genera domande Cryptography </h1>
</div>
<div class="container" id="box">
    ...
    <?php } ?>
    <form action="logicCrit.php" id="genrator">
...
<div id="argF">
    <form action="logicCrit.php" method="get">
        <div class="container">
            <div class="row">
                <div class="col">
