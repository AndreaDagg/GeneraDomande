...
$dbFileSys = array("Come si scrive e legge un dato più grande di un Cluster?", "Cos'è il flush","Cos'e' il bad cluster","bad cluster","MFT","Cos'e' il file system","metadata","file system jurnaled","Strutture della FAT","\$BITMAP");
...
$dbDir = array("diritto d'autore 633/41", "divulgazione pena","CNAIPIC","attacchi informatici piu' importanti","Truffa nigeriana","phishing, trashing boxing","truffa bancomat - pos");
