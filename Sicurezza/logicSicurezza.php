...
$dbIDS = array("Cosa sono gli IDS","Quali componenti ha in IDS","Di che tipo possono essere gli IDS", "Quale modailita' puo' utilizzare un IDS","Dove si trova un IDS NetworkBased","Cosa usa un IDS HostBased","Snort");
