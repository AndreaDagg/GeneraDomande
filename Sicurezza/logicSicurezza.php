...
$dbCifrari = array("A cosa serve un Cifrario?","Cifrario di sostituzione","Shift cipher & breaking","sobstitution cipher","pholyalphabetic substitution cipher & breaking","OTP","Perfect secret Enc. OTP","Dimostrazione OTP e' sicuro","Limitazioni OTP","Perche' non si usa bene OTP","PRG & F. One Way","Determinismo & non determinismo","Perché OTP Computazionale non è sicuro contro attacchi attivi","Come implementiamo otp nella realta'","P.R.F","Cpa Sec","Mesaggi variabili CPA Sec","P.R.P","tabella xOR e proprieta'");
$dbH_M_K = array("");
$dbIP_I_P = array("");
